                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <CardDescription className="flex items-center mt-1">
                      ...
                      {formatDistanceToNow(presentation.updatedAt.toDate(), {
                        addSuffix: true,
                      })}
                    </CardDescription>
                  </div>
                  ...
                  <div className="aspect-video bg-gray-100 rounded border overflow-hidden flex items-center justify-center">
                    {presentation.slides.length > 0 ? (
                      ...
                      >
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div
                            ...
                            style={{
                              width: "240px", // Fixed width for consistent preview
                              height: "144px", // 16:9.6 aspect ratio (240/144 = 1.67, close to slide ratio)
                              backgroundColor:
                                presentation.slides[0].background.color,
                              transform: "scale(1)",
                              overflow: "hidden",
                            }}
                          >
                            {presentation.slides[0].elements.map((element) => (
                              <div
                                ...
                                style={{
                                  left: (element.position.x / 1000) * 240, // Scale position to preview size
                                  top: (element.position.y / 600) * 144,
                                  width: Math.min(
                                    (element.size.width / 1000) * 240,
                                    240
                                  ), // Scale size to preview
                                  height: Math.min(
                                    (element.size.height / 600) * 144,
                                    144
                                  ),
                                  fontSize: Math.max(
                                    (element.style.fontSize / 1000) * 240 * 0.1,
                                    8
                                  ), // Scale font size
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-xs text-gray-500">No slides</p>
                      </div>
                    )}
                  </div>
                </div>
